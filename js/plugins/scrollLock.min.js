  ...
  t.CORE = {
    ...
    handler: function(i) {
      ...
      if (
        ...
        !i.ctrlKey &&
        ((r = n(i.currentTarget)),
        this.options.strict !== !0 || this.options.strictFn(r))
      ) {
        i.stopPropagation();
        var f = r.scrollTop(),
          ...
          e =
            ...
            -1 * i.originalEvent.deltaY,
          u = 0;
        i.type === 'wheel'
          ? ((s = r.height() / n(window).height()),
            (u = i.originalEvent.deltaY * s))
          : this.options.touch &&
            i.type === 'touchmove' &&
            (e = i.originalEvent.changedTouches[0].clientY - this.startClientY);
        ((h = e > 0 && f + u <= 0) || (e < 0 && f + u >= c - l)) &&
          (i.preventDefault(),
          u && r.scrollTop(f + u),
          (o = h ? 'top' : 'bottom'),
          this.options.animation &&
            setTimeout(t.CORE.animationHandler.bind(this, r, o), 0),
          r.trigger(n.Event(o + t.NAMESPACE)));
      }
    },
